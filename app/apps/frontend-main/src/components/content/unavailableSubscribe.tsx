...
const ContentUnavailableSubscribe: FC<Props> = ({ data, subscribeCallback }: Props) => {
  return <div className="w-full h-48 px-4 bg-neutral-300 flex flex-col justify-around items-center">
    ...
    <div className="w-full p-2 border border-neutral-400 rounded-lg flex flex-col gap-2">
      ...
      <button
        className="btn btn-success btn-block text-neutral-100"
        onClick={ () => subscribeCallback(1) }
      >Subscribe to see posts</button>
    </div>
  </div>;
};
