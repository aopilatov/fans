...
export class CreatorDbRepository {
  ...
  public async create(user: UserDbModel, login: string, name: string, infoShort: string, infoLong?: string, image?: Record<string, any>[], artwork?: Record<string, any>[]): Promise<CreatorDbModel> {
